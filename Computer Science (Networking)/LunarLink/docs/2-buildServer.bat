...
echo This batch file assumes your package structure for your Server is: server
...
javac %JAVAFX_ARGS% -sourcepath %PRAC_SRC% -cp %PRAC_BIN%;%PRAC_LIB% -d %PRAC_BIN% %PRAC_SRC%\server\ImgServer.java
IF /I "%ERRORLEVEL%" NEQ "0" (
...
java %JAVAFX_ARGS% -cp %PRAC_BIN%;%PRAC_LIB% server.ImgServer
IF /I "%ERRORLEVEL%" NEQ "0" (
