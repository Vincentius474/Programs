...
echo This batch file assumes your package structure for your Client is: ImgClient
...
javac %JAVAFX_ARGS% -sourcepath %PRAC_SRC% -cp %PRAC_BIN%;%PRAC_LIB% -d %PRAC_BIN% %PRAC_SRC%\client\ImgClient.java
IF /I "%ERRORLEVEL%" NEQ "0" (
...
java %JAVAFX_ARGS% -cp %PRAC_BIN%;%PRAC_LIB% client.ImgClient
IF /I "%ERRORLEVEL%" NEQ "0" (
