...
echo This batch file assumes your package structure for your Client is: client
...
REM javadoc %JAVAFX_ARGS% -sourcepath %PRAC_SRC% -classpath %PRAC_BIN%;%PRAC_LIB% -use -version -author -d REM %PRAC_DOCS%\%PRAC_JDOC% -subpackages client
